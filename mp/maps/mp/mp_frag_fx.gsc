main()
{
	level._effect[ "vfx_godray_frag_anim_solid_ori" ] = loadfx( "vfx/ambient/lights/vfx_godray_frag_anim_solid_ori" );
	level._effect[ "vfx_dirt_trail_falling_thick_frag" ] = loadfx( "vfx/ambient/dust/vfx_dirt_trail_falling_thick_frag" );
	level._effect[ "vfx_godray_frag_window_streak" ] = loadfx( "vfx/ambient/lights/vfx_godray_frag_window_streak" );
	level._effect[ "vfx_godray_frag_anim_streak2" ] = loadfx( "vfx/ambient/lights/vfx_godray_frag_anim_streak2" );
	level._effect[ "smoky_fluorescent_light_fit_frag_ug" ] = loadfx( "vfx/ambient/lights/smoky_fluorescent_light_fit_frag_ug" );
	level._effect[ "vfx_sprinkler_system_frag" ] 			= loadfx( "vfx/ambient/water/vfx_sprinkler_system_frag" );
	level._effect[ "vfx_dirt_trail_falling_thin" ] 			= loadfx( "vfx/ambient/dust/vfx_dirt_trail_falling_thin" );
	level._effect[ "vfx_dock_mist_close" ] 					= loadfx( "vfx/ambient/atmospheric/vfx_dock_mist_close" );
	...
	level._effect[ "vfx_dock_mist" ] 						= loadfx( "vfx/ambient/atmospheric/vfx_dock_mist" );
	...
	level._effect[ "vfx_sunflare_frag" ] 						= loadfx( "vfx/ambient/atmospheric/vfx_sunflare_frag" );
